...
For running cms python tests without ``collectstatic`` use this command.
...
And this command runs a single nose test within the file.
...
Use this command to get html report.
...
In both cases the captured screenshots will go to the same folder as when using the step method -
