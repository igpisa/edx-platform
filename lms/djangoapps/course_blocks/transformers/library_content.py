...
class ContentLibraryTransformer(BlockStructureTransformer):
    ...
    def transform(self, user_info, block_structure):
        ...
        for block_key in block_structure.topological_traversal(
            ...
            if library_children:
                ...
                all_selected_children.update(user_info.course_key.make_usage_key(s[0], s[1]) for s in selected)
    ...
    def _get_selected_modules(cls, user, course_key, block_key):
        """
        Get list of selected modules in a library for the given user.
